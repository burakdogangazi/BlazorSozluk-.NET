    ...
    internal class SeedData
    {
        private static List<User> GetUsers()
        {
            var result = new Faker<User>("tr")
                 ...
                 .RuleFor(i => i.Password, i => PassswordEncryptor.Encrypt(i.Internet.Password()))
        ...
        public async Task SeedAsync(IConfiguration conStr)
        {
            var dbContextBuilder = new DbContextOptionsBuilder();
            dbContextBuilder.UseSqlServer(conStr["BlazorSozlukDbConnectionString"]);
